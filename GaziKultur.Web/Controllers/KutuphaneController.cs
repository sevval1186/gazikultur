        ...
        private List<Kutuphane> KutuphaneleriGetir()
        {
            return new List<Kutuphane>
            {
                new Kutuphane
                {
                    ...
                    KisaAciklama = "Sessiz çalışma alanları ve geniş kitap koleksiyonuyla hizmet vermektedir.",
                ...
                new Kutuphane
                {
                    ...
                    KisaAciklama = "Öğrenciler için çalışma ve araştırma alanları bulunan modern bir kütüphane.",
                ...
                new Kutuphane
                {
                    ...
                    KisaAciklama = "Kitap okumak, araştırma yapmak ve ders çalışmak isteyen ziyaretçiler için hazırlanmış bir alandır.",
